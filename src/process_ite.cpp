...
ProcessIte::ProcessIte() {}

ProcessIte::~ProcessIte() {input_file.close();}

// Initialization for the word processing
bool ProcessIte::initialize(const std::string &input_file_name)
{
    std::string line;
    size_t count = 0;
...
bool ProcessIte::is_input_size_zero()
{
    if (word_ok.size() == 0) {
        return true;
    }
...
void ProcessIte::remove_used_words()
{
...
// Test single words
bool ProcessIte::test_single_word(const size_t len)
{
...
bool ProcessIte::test_double_word(const size_t len)
{
    size_t n1, n2;
...
bool ProcessIte::test_triple_word(const size_t len)
{
    size_t n1, n2, n3;
...
// Test combinations of 1 words
bool ProcessIte::test_quadruple_word(const size_t len)
{
    size_t n1, n2, n3, n4;
...
bool ProcessIte::test_quintuple_word(const size_t len)
{
...
bool ProcessIte::test_all_words(size_t len)
{
...
bool ProcessIte::are_all_words_length_one()
{
...
void ProcessIte::add_length_one_words()
{
...
void ProcessIte::fill_word_matrix_plus()
{
...
void ProcessIte::fill_word_matrix()
{
...
void ProcessIte::print_input_words(std::vector<std::string> const &words)
{
    std::printf("==========\n");
...
void ProcessIte::print_input_file_content()
{
...
void ProcessIte::print_output_matrix()
{
    std::printf("\nOutput matrix:\n");
    std::printf("==========\n");
